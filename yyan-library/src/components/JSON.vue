...
<template>
  <div class="json-lab">
    ...
    <section class="lab-section">
      ...
      <!-- 使用class binding来高亮特定作者 -->
      <ul>
        <li v-for="author in authors" :key="author.id"
            :class="{ active: isActive, highlight: author.name === 'George Orwell' }">
          {{ author.name }} ({{ author.birthYear }})
        </li>
      </ul>
...
import authors from "../assets/jason//authors.json"
import bookstores from "../assets/jason/bookstores.json"
const showMessage = ref(false)

// 新增：用于attribute, class和style binding的响应式数据
